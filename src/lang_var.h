...
// Verifica qual idioma foi selecionado no configs.h
#if defined(LANG_PT)
// #################### SEÇÃO PORTUGUÊS (PT-BR) ####################

//Starting window texts
PROGMEM const char text0_0[] = "Abrindo espaco para HardwareSerial...";
PROGMEM const char text0_1[] = "Serial iniciada";
PROGMEM const char text0_2[] = "RAM verificada";
PROGMEM const char text0_3[] = "Cartao SD iniciado";
PROGMEM const char text0_4[] = "Falha ao iniciar Cartao SD";
PROGMEM const char text0_5[] = "Configuracao de bateria verificada";
PROGMEM const char text0_6[] = "Interface de temperatura iniciada";
PROGMEM const char text0_7[] = "Interface LED iniciada";
PROGMEM const char text0_8[] = "Iniciando...";

//Single library (action) texts/Often used
PROGMEM const char text00[] = "Nivel Bateria mudou: ";
PROGMEM const char text01[] = "Arquivo fechado";
PROGMEM const char text02[] = "Falha ao abrir arquivo '";
...
PROGMEM const char text1_4[] = "Config. desativada";
PROGMEM const char text1_5[] = "Config. ativada";
...
PROGMEM const char text1_12[] = "Selecione Metodo ";
PROGMEM const char text1_13[] = "Confirmar Att. ";
PROGMEM const char text1_14[] = "Atualizar ESP8266 ";
PROGMEM const char text1_15[] = "Atualizar Firmware ";
PROGMEM const char text1_16[] = "Idioma ";
PROGMEM const char text1_17[] = "Info Dispositivo ";
...
PROGMEM const char text1_37[] = "Rodar Ducky Script";
PROGMEM const char text1_38[] = "Desenhar";
PROGMEM const char text1_39[] = "Atualizar Web";
PROGMEM const char text1_40[] = "Atualizar SD";
PROGMEM const char text1_41[] = "Atualizar ESP8266";
PROGMEM const char text1_42[] = "Sniffar Probe Req";
PROGMEM const char text1_43[] = "Sniffar Beacon";
PROGMEM const char text1_44[] = "Sniffar Deauth";
PROGMEM const char text1_45[] = "Monitor de Pacotes";
PROGMEM const char text1_46[] = "Escanear EAPOL/PMKID";
PROGMEM const char text1_47[] = "Detectar Pwnagotchi";
PROGMEM const char text1_48[] = "Detectar Espressif";
PROGMEM const char text1_49[] = "Escanear APs";
PROGMEM const char text1_50[] = "Spam Beacon (Lista)";
PROGMEM const char text1_51[] = "Spam Beacon (Aleat.)";
PROGMEM const char text1_52[] = "Beacon Rick Roll";
PROGMEM const char text1_53[] = "Flood Probe Req";
PROGMEM const char text1_54[] = "Flood Deauth";
PROGMEM const char text1_55[] = "Conectar WiFi";
PROGMEM const char text1_56[] = "Selecionar APs";
PROGMEM const char text1_57[] = "Spam Clone AP";
PROGMEM const char text1_58[] = "Captura Raw";
PROGMEM const char text1_59[] = "Sniffar Estacao";
...
PROGMEM const char text2_0[] = "Erro, nao achei update.bin";
PROGMEM const char text2_1[] = "Iniciando Att. do SD...";
...
PROGMEM const char text2_5[] = "Tam. Arq.: ";
PROGMEM const char text2_6[] = "Gravando arq. na particao...";
PROGMEM const char text2_7[] = "Gravado: ";
PROGMEM const char text2_8[] = "Gravado apenas : ";
PROGMEM const char text2_9[] = ". Tentar de novo?";
PROGMEM const char text2_10[] = " com sucesso";
PROGMEM const char text2_11[] = "Atualizacao completa";
PROGMEM const char text2_12[] = "Atualizacao nao pode completar";
PROGMEM const char text2_13[] = "Ocorreu um erro. Erro #: ";
PROGMEM const char text2_14[] = "Sem espaco para iniciar OTA";

//Web.cpp texts
PROGMEM const char text3_0[] = "Configurando servidor OTA...\n\n";
PROGMEM const char text3_1[] = "Endereco IP: ";
PROGMEM const char text3_2[] = "Atualizacao: ";
PROGMEM const char text3_3[] = "Bytes completos: ";
PROGMEM const char text3_4[] = "Sucesso Att.: ";
PROGMEM const char text3_5[] = "\nConfig. servidor OTA completa";

//WiFiScan.cpp texts
PROGMEM const char text4_0[] = " RSSI: ";
PROGMEM const char text4_1[] = "Possivel Skimmer: ";
...
PROGMEM const char text4_8[] = "Flood Probe";
...
PROGMEM const char text4_14[] = "SSIDs Gerados: ";     //Add spaces before to match : [15]
PROGMEM const char text4_15[] = "   Total SSIDs: ";      //Add spaces beforer to match : [14]
PROGMEM const char text4_16[] = "Desligando WiFi...";
PROGMEM const char text4_17[] = "WiFi nao iniciado";
PROGMEM const char text4_18[] = "Desligando BLE...";
PROGMEM const char text4_19[] = "BLE nao iniciado";
...
PROGMEM const char text4_23[] = "Bypass WSL: ativo";
PROGMEM const char text4_24[] = "Bypass WSL: inativo";
PROGMEM const char text4_25[] = "MAC Estacao: ";
PROGMEM const char text4_26[] = "MAC AP: ";
PROGMEM const char text4_27[] = "";
PROGMEM const char text4_28[] = "Cartao SD: Conectado";
PROGMEM const char text4_29[] = "Tam. SD: ";
PROGMEM const char text4_30[] = "Cartao SD: Nao Conectado";
PROGMEM const char text4_31[] = "Tam. SD: 0";
PROGMEM const char text4_32[] = "IP5306 I2C: suportado";
PROGMEM const char text4_33[] = "Nivel Bat.: ";
PROGMEM const char text4_34[] = "IP5306 I2C: nao suportado";
...
PROGMEM const char text4_38[] = " Sniffer Beacon ";
PROGMEM const char text4_39[] = " Sniffer Deauth ";
PROGMEM const char text4_40[] = " Sniffer Probe Req ";
PROGMEM const char text4_41[] = " Sniffer Bluetooth ";
PROGMEM const char text4_42[] = " Detectar Skimmers ";
PROGMEM const char text4_43[] = "Escan.\nSkimmers Bluetooth\nHC-03, HC-05, e HC-06...";
PROGMEM const char text4_44[] = " Escanear APs ";
